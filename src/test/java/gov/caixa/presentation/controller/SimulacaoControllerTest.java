...
class SimulacaoControllerTest {
        ...
        void deveCriarSimulacaoComSucesso() {
                ...
                Simulacao simulacao = new Simulacao(
                                ...
                                Instant.now());
                Produto produto = new Produto(1L, "CDB Caixa", "CDB",
                                new BigDecimal("0.10"), "Baixo", 6, 24,
                ...
                when(criarSimulacaoUseCase.executar(eq(123L), any(BigDecimal.class), eq(12), eq("CDB")))
                                .thenReturn(new CriarSimulacaoUseCase.Resultado(simulacao, produto));
                ...
                given()
                                ...
                                .body("produtoValidado.risco", equalTo("Baixo"))
